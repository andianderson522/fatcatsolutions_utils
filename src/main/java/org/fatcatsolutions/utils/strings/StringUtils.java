...
public final class StringUtils {
   ...
   * @return {@link StringUtils#EMPTY_STRING} if CharSequence is null, blank or
   ...
   * @return boolean whether or not the given CharSequence is null, blank or only
   *         contains spaces
   */
   ...
   * @param toCheck
   *                {@link CharSequence} to check
   * @return boolean Returns true if the CharSequence to check is not null and
   *         contains text other then white space
   */
